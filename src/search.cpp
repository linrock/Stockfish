...
constexpr int sbDMult = 184;
constexpr int sbMax = 1429;
constexpr int smDMult = 718;
constexpr int smMax = 2010;
constexpr int ssTh = -8070;
constexpr int bMax = 231;
constexpr int betaOffset = 164;
