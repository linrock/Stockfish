...
constexpr int sbDMult = 185;
constexpr int sbMax = 1399;
constexpr int smDMult = 741;
constexpr int smMax = 1956;
constexpr int ssTh = -8111;
constexpr int bMax = 225;
constexpr int betaOffset = 167;
