...
constexpr   int TUNE_optMult = 128;
constexpr   int TUNE_optDenomOffset = 157;
constexpr   int TUNE_futPruneCapEvalOffset = 182;
constexpr   int TUNE_futPruneParentEvalOffset = 140;
