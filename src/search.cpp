...
namespace {
  ...
  int TUNE_histReducDenom = 12800;
  int TUNE_histReducDenomMidDepth = 4410;
  TUNE(SetRange(11800, 13800), TUNE_histReducDenom);
  TUNE(SetRange(4000, 4800), TUNE_histReducDenomMidDepth);
...
moves_loop: // When in check, search starts here
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
      ...
      r -= ss->statScore / (TUNE_histReducDenom +
                            TUNE_histReducDenomMidDepth * (depth > 7 && depth < 19));
