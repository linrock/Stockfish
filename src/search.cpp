...
constexpr   int TUNE_fpcEvalOffset = 160;
constexpr   int TUNE_fpcLmrDepthMult = 325;
constexpr   Value TUNE_seeDepthMult = Value(-220);
constexpr   int TUNE_fpEvalOffset = 172;
constexpr   int TUNE_fpDepthMult = 138;
constexpr   int TUNE_negSeeDepthMultSq = -49;
