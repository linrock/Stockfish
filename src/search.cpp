...
namespace {
  ...
  int TUNE_histDenom = 7130;
  int TUNE_lmrDepthMult = 138;
  int TUNE_staticEvalOffset = 107;

  int TUNE_reducDenomConst = 12367;
  int TUNE_reducDenomMidMult = 4537;
  int TUNE_statScoreOffset = 4477;
