...
constexpr   int TUNE_fpcEvalOffset = 334;
constexpr   int TUNE_fpcLmrDepthMult = 265;
constexpr   Value TUNE_seeDepthMult = Value(-231);
constexpr   int TUNE_fpEvalOffset = 157;
constexpr   int TUNE_fpDepthMult = 147;
constexpr   int TUNE_negSeeDepthMultSq = -27;
constexpr   int TUNE_histDenom = 7098;
constexpr   int TUNE_chpruneDMult = -4462;
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
              ...
              || givesCheck)
          {
              ...
              if (!pos.see_ge(move, TUNE_seeDepthMult * depth))
                  continue;
          }
          else
          {
