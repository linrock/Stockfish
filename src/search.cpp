...
constexpr int fvOffset = 299;
constexpr int fvLmrMult = 250;
constexpr int seeGeDMult = -160;
constexpr int histDMult = -3820;
constexpr int histDiv = 4113;
constexpr int bvTh1 = 137;
constexpr int bvTh2 = 57;
