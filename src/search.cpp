...
constexpr   int TUNE_optMult = 75;
constexpr   int TUNE_optDenomOffset = 128;
constexpr   int TUNE_futPruneCapEvalOffset = 170;
constexpr   int TUNE_futPruneParentEvalOffset = 179;
