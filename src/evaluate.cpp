...
constexpr Value LazyThreshold2 = Value(1988);
constexpr int TUNE_psqlThresh = 1770;
constexpr int TUNE_nnueScale = 906;
constexpr int TUNE_nnueScalePc = 5;
constexpr int TUNE_nnueScaleNpMat = 61;
constexpr int TUNE_nnueComplexityMult = 400;
constexpr int TUNE_nnueNumOffset = 254;
