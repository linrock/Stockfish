...
bool Eval::use_smallnet(const Position& pos) {
    ...
    return std::abs(simpleEval) > 978 + 6 * pawnCount * pawnCount / 16;
}
...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    int material = 244 * pos.count<PAWN>() + 350 * pos.count<KNIGHT>() + 400 * pos.count<BISHOP>()
                 + 640 * pos.count<ROOK>() + 1200 * pos.count<QUEEN>();

    v = (nnue * (34300 + material) + optimism * (4400 + material)) / 37758;
