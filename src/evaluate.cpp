...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3709);
  constexpr Value LazyThreshold2    =  Value(1969);
  constexpr Value SpaceThreshold    =  Value(11491);
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1832);
  ...
  else
  {
      ...
      nnueComplexity = (  394 * nnueComplexity
                        + 424 * abs(psq - nnue)
