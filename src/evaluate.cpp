...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3467);
  constexpr Value LazyThreshold2    =  Value(2153);
  constexpr int useClassicalPsqtThresh = 1762;
  constexpr int nnueComplexityScale = 373;
  constexpr int nnueComplexityOffset = 271;
  constexpr int pDamp1 = 232;
