...
constexpr   Value LazyThreshold1 = Value(3521);
constexpr   Value LazyThreshold2 = Value(2043);
constexpr   int TUNE_psqThresh = 1965;
constexpr   int TUNE_nnueComplexityMult = 396;
constexpr   int TUNE_nnueOptCompOffset = 283;
constexpr   int TUNE_scaleBase = 988;
constexpr   int TUNE_scalePcMult = 154;
constexpr   int TUNE_scaleNonPawnMat = 62;
