...
constexpr       int TUNE_nnueScaleBase = 938;
constexpr       int TUNE_nnueScalePawnMult = 75;
constexpr       int TUNE_nnueScaleNpMult = 14;
constexpr       int TUNE_optScaleBase = 187;
constexpr       int TUNE_optScalePawnMult = -36;
constexpr       int TUNE_optScaleNpMult = 42;
