...
namespace {
  ...
  int TUNE_psqThresh = 2051;
  int TUNE_nnueComplexityMult = 440;
  int TUNE_nnueOptCompOffset = 258;
  int TUNE_scaleOffset = 733;
  ...
  int TUNE_scaleBase = 1034;
  int TUNE_scaleNonPawnMat = 49;
