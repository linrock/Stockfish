...
constexpr   int TUNE_nnueScaleBase = 976;
constexpr   int TUNE_nnueComplexityMult = 414;
constexpr   int TUNE_evalOptOffset = 420;
constexpr   int TUNE_evalOptComplexityOffset = 266;
constexpr   int TUNE_scaleOffset = 807;
