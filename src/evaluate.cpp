...
constexpr Value LazyThreshold2 = Value(1973);
constexpr int TUNE_psqlThresh = 1785;
constexpr int TUNE_nnueScale = 997;
constexpr int TUNE_nnueScalePc = 8;
constexpr int TUNE_nnueScaleNpMat = 64;
constexpr int TUNE_nnueComplexityMult = 393;
constexpr int TUNE_nnueNumOffset = 288;
