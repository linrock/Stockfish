...
constexpr   Value LazyThreshold1 = Value(3487);
constexpr   Value LazyThreshold2 = Value(2027);
constexpr   int TUNE_psqThresh = 1968;
constexpr   int TUNE_nnueComplexityMult = 400;
constexpr   int TUNE_nnueOptCompOffset = 282;
constexpr   int TUNE_scaleBase = 993;
constexpr   int TUNE_scalePcMult = 138;
