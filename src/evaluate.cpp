...
namespace Stockfish {
  ...
  int TUNE_snOptDiv = 453;
  int TUNE_mainOptDiv = 468;
  int TUNE_snNnueDiv = 21480;
  int TUNE_mainNnueDiv = 16545;
  int TUNE_vMatOffset = 80135;
  int TUNE_vSnDiv = 76713;
  int TUNE_vMainDiv = 78900;
  int nnuePsqSeMult = 30;
  int optPsqSeMult = -35;
