...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3442);
  constexpr Value LazyThreshold2    =  Value(1880);
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || abs(psq) > 2084;
  ...
  {
      int nnueComplexity;
      int scale = 986 + 139 * pos.count<PAWN>() / 32 + 60 * pos.non_pawn_material() / 4096;
