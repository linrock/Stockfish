...
constexpr int reTh = 235;
constexpr int optDiv = 448;
constexpr int nnueDiv = 18834;
constexpr int optMin = -60;
constexpr int evalDiv = 68200;
...
bool Eval::use_smallnet(const Position& pos, int optimism) {
    ...
    return std::abs(simpleEval) > snTh - std::clamp(3 * optimism / 4, optMin, 0);
}
...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    v            = (nnue * (73921 + material) + optimism * (8112 + material)) / evalDiv;
