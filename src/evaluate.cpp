...
namespace Stockfish {
    ...
    constexpr int TUNE_ncMult = 28;
    constexpr int TUNE_seMult = 24;
    constexpr int TUNE_optDenom = 15174;
    constexpr int TUNE_nnueDenom = 1243275;
    constexpr int TUNE_nnueNpmBase = 903;
    constexpr int TUNE_optNpmBase = 83;
