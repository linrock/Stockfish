...
constexpr   Value LazyThreshold1 = Value(3573);
constexpr   Value LazyThreshold2 = Value(1888);
constexpr   int TUNE_psqThresh = 1959;
constexpr   int TUNE_nnueComplexityMult = 405;
constexpr   int TUNE_nnueOptCompOffset = 285;
constexpr   int TUNE_scaleBase = 992;
constexpr   int TUNE_scalePcMult = 165;
