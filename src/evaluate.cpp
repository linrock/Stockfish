...
namespace Stockfish {
    ...
    constexpr int snThresh = 950;
    constexpr int reThresh = 219;
    constexpr int optDiv = 464;
    constexpr int nnueDiv = 18428;
    constexpr int nnueMatOffset = 74364;
    constexpr int optMatOffset = 7990;
    constexpr int evalDiv = 76340;
