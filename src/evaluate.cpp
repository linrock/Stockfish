...
constexpr  Value LazyThreshold1 = Value(3414);
constexpr  Value LazyThreshold2 = Value(2052);
constexpr  int TUNE_psqThresh = 1781;
constexpr  int TUNE_nnueComplexityMult = 406;
constexpr  int TUNE_nnueOptCompOffset = 281;
constexpr  int TUNE_nnueDampNum = 219;
