...
constexpr   int TUNE_nnueOptScaleBase = 1015;
constexpr   int TUNE_nnueComplexityOptPosOffset = 508;
constexpr   int TUNE_nnueComplexityOptNegOffset = 425;
constexpr   int TUNE_optScaleOffset = 836;
