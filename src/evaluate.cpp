...
namespace Stockfish {
    ...
    constexpr int snOptDiv = 434;
    constexpr int optDiv = 460;
    constexpr int snNnueDiv = 18872;
    constexpr int nnueDiv = 18035;
    constexpr int snEvalDiv = 69038;
    constexpr int evalDiv = 74676;
    constexpr int snPawnMult = 550;
