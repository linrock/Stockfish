...
constexpr   Value LazyThreshold1 = Value(3512);
constexpr   Value LazyThreshold2 = Value(1851);
constexpr   int TUNE_psqThresh = 1776;
constexpr   int TUNE_nnueComplexityMult = 413;
constexpr   int TUNE_nnueOptCompOffset = 274;
constexpr   int TUNE_scaleBase = 1005;
constexpr   int TUNE_scalePcMult = 5;
constexpr   int TUNE_scaleNonPawnMat = 67;
