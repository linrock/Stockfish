...
namespace Stockfish {
    ...
    constexpr int snThresh = 1022;
    constexpr int optDiv = 501;
    constexpr int nnueDiv = 32389;
    constexpr int pcMult = 399;
    constexpr int nnueMatOffset = 34585;
    constexpr int optMatOffset = 4307;
    constexpr int evalDiv = 35890;
