...
constexpr       Value TUNE_LazyThreshold1 = Value(3697);
constexpr       Value TUNE_LazyThreshold2 = Value(2035);
constexpr       int TUNE_psqThresh = 2077;
constexpr       int TUNE_npmOffset = 947;
