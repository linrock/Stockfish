...
namespace Stockfish {
    ...
    constexpr int snThresh = 1111;
    constexpr int snPc = 5;
    constexpr int optDivNc = 605;
    constexpr int optDivSimpEv = 581;
    constexpr int nnueDiv = 32296;
    constexpr int evalDiv = 960;
    constexpr int npmOffset = 948;
