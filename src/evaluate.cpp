...
constexpr  Value LazyThreshold1 = Value(3575);
constexpr  Value LazyThreshold2 = Value(2005);
constexpr  int TUNE_psqThresh = 1772;
constexpr  int TUNE_nnueComplexityMult = 411;
constexpr  int TUNE_nnueOptCompOffset = 270;
constexpr  int TUNE_nnueDampNum = 233;
