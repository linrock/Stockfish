...
constexpr int TUNE_nnueNpmMult = 30;
constexpr int TUNE_optNpmMult = 24;
constexpr int TUNE_nnueNpmBase = 1048;
constexpr int TUNE_optNpmBase = 295;
constexpr int TUNE_nnueScalePc = 10;
constexpr int TUNE_optScalePc = 6;
