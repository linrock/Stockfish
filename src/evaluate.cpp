...
namespace Stockfish {
    ...
    constexpr int snThresh = 997;
    constexpr int optDiv = 493;
    constexpr int nnueDiv = 19588;
    constexpr int nnuePcMult = 321;
    constexpr int optPcMult = 231;
    constexpr int evalDiv = 35413;
