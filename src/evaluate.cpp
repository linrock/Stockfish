...
namespace Stockfish {
    ...
    constexpr int snThresh = 1003;
    constexpr int optDiv = 477;
    constexpr int nnueDiv = 32806;
    constexpr int nnuePcMult = 185;
    constexpr int optPcMult = 105;
    constexpr int evalDiv = 36289;
