...
namespace Stockfish {
    ...
    constexpr int snThresh = 1054;
    constexpr int snPc = 4;
    constexpr int optDivNc = 573;
    constexpr int optDivSimpEv = 576;
    constexpr int nnueDiv = 32489;
    constexpr int evalDiv = 955;
    constexpr int npmOffset = 963;
