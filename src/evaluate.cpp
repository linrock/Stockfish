...
namespace {
  ...
  constexpr int SafeCheck[][2] = {
      {}, {}, {803, 1326}, {655, 986}, {1005, 1791}, {703, 1020}
  };
...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score MobilityBonus[][32] = {
    { S(-61,-75), S(-53,-56), S(-12,-31), S( -3,-16), S(  3,  7), S( 13, 13), // Knight
      S( 21, 17), S( 28, 21), S( 38, 27) },
    { S(-48,-63), S(-20,-27), S( 14, -8), S( 29, 12), S( 41, 22), S( 48, 39), // Bishop
      S( 51, 55), S( 58, 57), S( 66, 63), S( 71, 70), S( 78, 78), S( 82, 89),
      S( 86, 92), S( 89,100) },
    { S(-59,-83), S(-24,-14), S(  0, 17) ,S(  3, 40), S(  4, 76), S( 14,102), // Rook
      S( 19,102), S( 31,127), S( 40,122), S(41 ,134), S( 41,147), S( 44,163),
      S( 58,161), S( 60,169), S( 67,174) },
    { S(-27,-49), S(-15,-29), S( -8, -8), S( -8, 18), S( 17, 38), S( 25, 51), // Queen
      S( 22, 58), S( 36, 76), S( 39, 77), S( 55, 93), S( 66, 97) ,S( 67, 97),
      S( 65,124), S( 71,132), S( 67,121), S( 67,132) ,S( 71,143), S( 68,156),
      S( 72,135), S( 77,156), S( 91,147), S(106,170), S(108,163), S(106,175),
      S(110,171), S(110,193), S(119,187), S(126,217) }
  };
