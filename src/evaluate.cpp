...
namespace Stockfish {
    ...
    constexpr int snThresh = 1145;
    constexpr int snPc = 5;
    constexpr int reEvalThresh = 499;
    constexpr int optDiv = 624;
    constexpr int nnueDiv = 30994;
    constexpr int evalDiv = 1027;
    constexpr int npmOffset = 956;
