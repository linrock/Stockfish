...
constexpr       Value TUNE_LazyThreshold1 = Value(3723);
constexpr       Value TUNE_LazyThreshold2 = Value(2170);
constexpr       int TUNE_psqThresh = 2126;
constexpr       int TUNE_npmOffset = 956;
constexpr       int TUNE_optOffset = 150;
