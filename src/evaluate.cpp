...
namespace Stockfish {
    ...
    constexpr int snThresh = 1098;
    constexpr int snPc = 6;
    constexpr int optDivNc = 598;
    constexpr int optDivSimpEv = 586;
    constexpr int nnueDiv = 32614;
    constexpr int evalDiv = 989;
    constexpr int npmOffset = 946;
