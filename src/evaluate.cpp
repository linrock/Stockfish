...
constexpr   int TUNE_npmMult = 25;
constexpr   int TUNE_nnueNpmOffset = 945;
constexpr   int TUNE_optNpmOffset = 74;
constexpr   int TUNE_optMult = 2762;
constexpr   int TUNE_nnueDecayMult = 44;
