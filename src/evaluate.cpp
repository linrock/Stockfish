...
namespace {
  ...
  Value LazyThreshold1 = Value(3546);
  Value LazyThreshold2 = Value(1829);

  int TUNE_psqThresh = 1767;
  int TUNE_scaleBase = 935;
  int TUNE_scalePawnMult = 7;
  int TUNE_scaleNonPawnMult = 64;
  int TUNE_nnueComplexityMult = 405;
  int TUNE_complexityOptOffset = 416;
  int TUNE_nnueOptCompOffset = 279;
  int TUNE_vScaleOffset = 741;
