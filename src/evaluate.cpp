...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || abs(psq) > 2119;
  ...
  {
      int nnueComplexity;
      int scale = 987 + 61 * pos.non_pawn_material() / 4096;
      ...
      nnueComplexity = (  427 * nnueComplexity
      ...
      v = (nnue * scale + optimism * (scale - 760)) / 1024;
  }
