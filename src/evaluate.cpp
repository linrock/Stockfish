...
constexpr   int TUNE_pawnMult = 67;
constexpr   int TUNE_knightMult = 395;
constexpr   int TUNE_bishopMult = 288;
constexpr   int TUNE_rookMult = 630;
constexpr   int TUNE_queenMult = 857;
