...
constexpr int TUNE_rePosThresh = 47;
constexpr int TUNE_reNnueThresh = 246;
constexpr int TUNE_optDenom = 459;
constexpr int TUNE_snNcDenom = 20382;
constexpr int TUNE_ncDenom = 18158;
constexpr int TUNE_delta = 94;
