...
constexpr       int TUNE_scaleBase = 987;
constexpr       int TUNE_scalePawnMult = 5;
constexpr       int TUNE_scaleNonPawnMult = 63;
constexpr       int TUNE_optComplexOffset = 280;
constexpr       int TUNE_vScaleOffset = 752;
constexpr       int TUNE_psqThresh = 1787;
constexpr       int TUNE_nnueComplexMult = 408;
constexpr       int TUNE_nnueComplexOptOffset = 430;
constexpr       int TUNE_nnueDampNum = 253;
