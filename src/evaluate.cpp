...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3830);
  constexpr Value LazyThreshold2    =  Value(2044);
  constexpr Value SpaceThreshold    =  Value(11889);
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  else
  {
      ...
      nnueComplexity = (  370 * nnueComplexity
                        + 424 * abs(psq - nnue)
