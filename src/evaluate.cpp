...
constexpr      int TUNE_scaleBase = 963;
constexpr      int TUNE_scalePawnMult = 5;
constexpr      int TUNE_scaleNonPawnMult = 57;
constexpr      int TUNE_optComplexOffset = 270;
constexpr      int TUNE_vScaleOffset = 756;
constexpr      int TUNE_psqThresh = 1779;
constexpr      int TUNE_nnueComplexMult = 384;
constexpr      int TUNE_nnueComplexOptOffset = 435;
