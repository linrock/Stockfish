...
constexpr   int TUNE_pawnMult = 128;
constexpr   int TUNE_knightMult = 470;
constexpr   int TUNE_bishopMult = 189;
constexpr   int TUNE_rookMult = 455;
constexpr   int TUNE_queenMult = 880;
