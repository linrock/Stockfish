...
constexpr   int TUNE_nnueComplexityMult = 440;
constexpr   int TUNE_nnueOptCompOffset = 258;
constexpr   int TUNE_scaleOffset = 733;
constexpr   int TUNE_scaleBase = 1034;
constexpr   int TUNE_scaleNonPawnMat = 49;
