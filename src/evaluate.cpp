...
constexpr      int TUNE_scaleBase = 1026;
constexpr      int TUNE_scalePawnMult = 6;
constexpr      int TUNE_scaleNonPawnMult = 61;
constexpr      int TUNE_optComplexOffset = 265;
constexpr      int TUNE_vScaleOffset = 750;
constexpr      int TUNE_psqThresh = 1764;
constexpr      int TUNE_nnueComplexMult = 395;
constexpr      int TUNE_nnueComplexOptOffset = 441;
