...
constexpr int TUNE_npmMult = 26;
constexpr int TUNE_nnueNpmBase = 980;
constexpr int TUNE_optNpmBase = 180;
constexpr int TUNE_nnueScalePc = 15;
constexpr int TUNE_optScalePc = 1;
constexpr int TUNE_dampConst = 169;
