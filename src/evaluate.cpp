...
namespace Stockfish {
  ...
  constexpr int TUNE_nnueScaleBase = 900;
  constexpr int TUNE_nnueScalePawnMult = 36;
  constexpr int TUNE_nnueScaleNpMult = 22;

  constexpr int TUNE_optScaleBase = 177;
  constexpr int TUNE_optScalePawnMult = -16;
  constexpr int TUNE_optScaleNpMult = 27;

  constexpr int TUNE_nnueComplexityOptOffset = 461;
