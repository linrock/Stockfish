...
namespace {
  ...
  int TUNE_psqThresh = 2195;
  int TUNE_nnueComplexityMult = 451;
  int TUNE_nnueOptCompOffset = 267;
  int TUNE_scaleOffset = 749;
  ...
  int TUNE_scaleBase = 1028;
  int TUNE_scaleNonPawnMat = 69;
