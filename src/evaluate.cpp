...
constexpr       Value TUNE_LazyThreshold1 = Value(3633);
constexpr       Value TUNE_LazyThreshold2 = Value(2040);
constexpr       int TUNE_psqThresh = 2036;
constexpr       int TUNE_npmOffset = 987;
