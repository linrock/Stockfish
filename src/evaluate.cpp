...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3690);
  constexpr Value LazyThreshold2    =  Value(2178);
...
Value Eval::evaluate(const Position& pos) {
  ...
  bool useClassical = !useNNUE || abs(psq) > 2130;
  ...
  else
  {
      ...
      v = (nnue * (962 + npm) + optimism * (141 + npm)) / 1024;
  }
