...
constexpr   Value LazyThreshold1 = Value(3393);
constexpr   Value LazyThreshold2 = Value(1914);
constexpr   int TUNE_psqThresh = 1785;
constexpr   int TUNE_nnueComplexityMult = 405;
constexpr   int TUNE_nnueOptCompOffset = 275;
constexpr   int TUNE_scaleBase = 985;
constexpr   int TUNE_scalePcMult = 5;
constexpr   int TUNE_scaleNonPawnMat = 55;
