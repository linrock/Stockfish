...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3548);
  constexpr Value LazyThreshold2    =  Value(1905);
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  {
      int nnueComplexity;
      int scale = 989 + 106 * pos.count<PAWN>() / 32 + 58 * pos.non_pawn_material() / 4096;
      ...
      nnueComplexity = (  409 * nnueComplexity
