...
constexpr   Value LazyThreshold1 = Value(3707);
constexpr   Value LazyThreshold2 = Value(1902);
constexpr   int TUNE_psqThresh = 1780;
constexpr   int TUNE_scaleBase = 915;
constexpr   int TUNE_scalePawnMult = 4;
constexpr   int TUNE_scaleNonPawnMult = 59;
constexpr   int TUNE_nnueComplexityMult = 404;
constexpr   int TUNE_complexityOptOffset = 417;
constexpr   int TUNE_nnueOptCompOffset = 269;
constexpr   int TUNE_vScaleOffset = 733;
