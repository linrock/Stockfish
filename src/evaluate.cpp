...
constexpr  Value LazyThreshold1 = Value(3506);
constexpr  Value LazyThreshold2 = Value(1811);
constexpr  int TUNE_psqThresh = 1777;
constexpr  int TUNE_nnueComplexityMult = 406;
constexpr  int TUNE_nnueOptCompOffset = 279;
constexpr  int TUNE_nnueDampNum = 248;
