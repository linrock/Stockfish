...
constexpr   Value LazyThreshold1 = Value(3516);
constexpr   Value LazyThreshold2 = Value(2029);
constexpr   int TUNE_psqThresh = 1964;
constexpr   int TUNE_nnueComplexityMult = 397;
constexpr   int TUNE_nnueOptCompOffset = 281;
