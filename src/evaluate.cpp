...
constexpr   Value LazyThreshold1 = Value(3231);
constexpr   Value LazyThreshold2 = Value(1981);
constexpr   int TUNE_psqThresh = 1777;
constexpr   int TUNE_nnueComplexityMult = 405;
constexpr   int TUNE_nnueOptCompOffset = 266;
constexpr   int TUNE_nnueDampNum = 243;
