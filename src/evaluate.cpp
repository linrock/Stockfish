...
constexpr   int TUNE_scaleBase = 977;
constexpr   int TUNE_nnueComplexityOptOffset = 447;
constexpr   int TUNE_optScaleOffset = 774;
constexpr   int TUNE_nnuePieceCountThresh = 5;
constexpr   int TUNE_nnuePsqClassicThresh = 2340;
