...
namespace Stockfish {
    ...
    constexpr int TUNE_ncMult = 32;
    constexpr int TUNE_seMult = 24;
    constexpr int TUNE_optDenom = 16072;
    constexpr int TUNE_nnueDenom = 1110525;
    constexpr int TUNE_nnueNpmBase = 850;
    constexpr int TUNE_optNpmBase = 77;
