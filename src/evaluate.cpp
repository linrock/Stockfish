...
namespace Stockfish {
    ...
    constexpr int snThresh = 1143;
    constexpr int snPc = 6;
    constexpr int reEvalThresh = 490;
    constexpr int optDiv = 608;
    constexpr int nnueDiv = 31845;
    constexpr int evalDiv = 1033;
    constexpr int npmOffset = 943;
