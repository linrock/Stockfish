...
namespace {
  ...
  Value LazyThreshold1 = Value(3504);
  Value LazyThreshold2 = Value(1853);

  int TUNE_psqThresh = 1794;
  int TUNE_scaleBase = 1004;
  int TUNE_scalePawnMult = 7;
  int TUNE_scaleNonPawnMult = 59;
  int TUNE_nnueComplexityMult = 408;
  int TUNE_complexityOptOffset = 424;
  int TUNE_nnueOptCompOffset = 269;
  int TUNE_vScaleOffset = 746;
