...
Value PawnValue = Value(TUNE_pawnValue), KnightValue = Value(TUNE_knightValue), BishopValue = Value(TUNE_bishopValue),
      RookValue = Value(TUNE_rookValue), QueenValue = Value(TUNE_queenValue);
