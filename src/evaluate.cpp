...
namespace Stockfish {
    ...
    constexpr int snThresh = 1144;
    constexpr int snPc = 5;
    constexpr int reEvalThresh = 504;
    constexpr int optDiv = 630;
    constexpr int nnueDiv = 31138;
    constexpr int evalDiv = 1020;
    constexpr int npmOffset = 952;
