...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score MobilityBonus[][32] = {
    ...
    { S(-48,-59), S(-20,-23), S( 16, -3), S( 26, 13), S( 38, 24), S( 51, 42), // Bishop
      ...
      S( 91, 88), S( 98, 97) },
    { S(-55,-54), S(-15, -6), S( 32, 14), S( 32, 41), S( 32, 62), S( 31,108), // Rook
      S( 45,110), S( 59,105), S( 62,120), S( 62,149), S( 53,153), S( 57,185),
      S( 63,184), S( 94,173), S( 79,154) },
    { S(-25,-44), S(-29,-33), S( 11, -6), S( 15, 20), S(  6, 32), S( 23, 53), // Queen
      S( 24, 53), S( 34, 60), S( 45, 53), S( 50, 86), S( 73, 72), S( 60,111),
      S( 72,112), S( 80,120), S( 70,130), S( 49,112), S( 83,122), S( 78,155),
      S( 55,120), S( 85,146), S( 84,162), S(108,193), S(102,162), S( 81,161),
      S(118,189), S( 99,167), S(104,177), S(111,234) }
  };

  // RookOnFile[semiopen/open] contains bonuses for each rook when there is
  // no (friendly) pawn on the rook file.
  constexpr Score RookOnFile[] = { S(20, 7), S(53, 35) };
  ...
  constexpr Score ThreatByRook[PIECE_TYPE_NB] = {
    S(0, 0), S(5, 44), S(37, 70), S(48, 65), S(0, 38), S(54, 42)
  };
  ...
  constexpr Score RookOnQueenFile     = S(  7,  9);
  constexpr Score SliderOnQueen       = S( 59, 18);
  constexpr Score ThreatByKing        = S( 24, 89);
  constexpr Score ThreatByPawnPush    = S( 48, 39);
  constexpr Score ThreatBySafePawn    = S(173, 94);
  constexpr Score TrappedRook         = S( 60, 11);
  constexpr Score WeakQueen           = S( 58, 18);
