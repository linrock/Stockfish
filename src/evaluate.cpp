...
constexpr   int TUNE_scaleBase = 1007;
constexpr   int TUNE_scaleNonPawnMult = 32;
constexpr   int TUNE_nnueComplexityOptOffset = 471;
constexpr   int TUNE_optScaleOffset = 712;
constexpr   int TUNE_nnuePsqClassicThresh = 2258;
...
Value Eval::evaluate(const Position& pos) {
  ...
  bool useClassical = !useNNUE || abs(psq) > TUNE_nnuePsqClassicThresh;
  ...
  {
      int nnueComplexity;
      int scale = TUNE_scaleBase + TUNE_scaleNonPawnMult * pos.non_pawn_material() / 2048;
      ...
      nnueComplexity = (  402 * nnueComplexity
                        + TUNE_nnueComplexityOptOffset * abs(psq - nnue)
