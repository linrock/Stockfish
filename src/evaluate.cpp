...
constexpr      int TUNE_scaleBase = 999;
constexpr      int TUNE_scalePawnMult = 5;
constexpr      int TUNE_scaleNonPawnMult = 55;
constexpr      int TUNE_optComplexOffset = 293;
constexpr      int TUNE_vScaleOffset = 754;
constexpr      int TUNE_psqThresh = 1772;
constexpr      int TUNE_nnueComplexMult = 446;
constexpr      int TUNE_nnueComplexOptOffset = 423;
constexpr      int TUNE_nnueDampNum = 231;
