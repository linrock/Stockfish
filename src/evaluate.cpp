...
namespace Stockfish {
    ...
    constexpr int snThresh = 1059;
    constexpr int optDiv = 510;
    constexpr int nnueDiv = 32639;
    constexpr int pcMult = 475;
    constexpr int nnueMatOffset = 34668;
    constexpr int optMatOffset = 4431;
    constexpr int evalDiv = 35375;
