...
namespace Stockfish {
    ...
    constexpr int snThresh = 994;
    constexpr int optDiv = 496;
    constexpr int nnueDiv = 19787;
    constexpr int nnuePcMult = 413;
    constexpr int optPcMult = 220;
    constexpr int evalDiv = 35839;
