...
constexpr Value LazyThreshold2 = Value(1977);
constexpr int TUNE_psqlThresh = 1785;
constexpr int TUNE_nnueScale = 1009;
constexpr int TUNE_nnueScalePc = 9;
constexpr int TUNE_nnueScaleNpMat = 61;
constexpr int TUNE_nnueComplexityMult = 385;
constexpr int TUNE_nnueNumOffset = 287;
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  {
      int nnueComplexity;
      int scale = TUNE_nnueScale + TUNE_nnueScalePc * pos.count<PAWN>()
                                 + TUNE_nnueScaleNpMat * pos.non_pawn_material() / 4096;
