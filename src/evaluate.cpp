...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score BishopBehindOurPawn = S( 18,  0);
  constexpr Score KnightBehindOurPawn = S( 20,  0);
  constexpr Score BishopBehindTheirPawn = S( 19,  3);
  constexpr Score KnightBehindTheirPawn = S( 17,  3);
