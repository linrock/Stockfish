...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3958);
  constexpr Value LazyThreshold2    =  Value(1796);
  constexpr int useClassicalPsqtThresh = 1761;
  constexpr int nnueComplexityScale = 367;
  constexpr int nnueComplexityOffset = 311;
  constexpr int pDamp1 = 220;
