...
constexpr   int TUNE_scaleBase = 973;
constexpr   int TUNE_nnueComplexityOptOffset = 519;
constexpr   int TUNE_optScaleOffset = 767;
constexpr   int TUNE_nnuePieceCountThresh = 7;
constexpr   int TUNE_nnuePsqClassicThresh = 2178;
