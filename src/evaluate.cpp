...
namespace {
  ...
  constexpr int QueenSafeCheck  = 763;
  constexpr int RookSafeCheck   = 1078;
  constexpr int BishopSafeCheck = 660;
  constexpr int KnightSafeCheck = 814;
...
#undef S
  ...
  Score Evaluation<T>::king() const {
    ...
    if (rookChecks)
        kingDanger += more_than_one(rookChecks) ? RookSafeCheck * 173/100
                                                : RookSafeCheck;
    else
    ...
    queenChecks =  (b1 | b2)
                 ...
                 & ~rookChecks;
    if (queenChecks)
        kingDanger += more_than_one(queenChecks) ? QueenSafeCheck * 130/100
                                                 : QueenSafeCheck;
    ...
    bishopChecks =  b2
                  ...
                  & ~queenChecks;
    if (bishopChecks)
        kingDanger += more_than_one(bishopChecks) ? BishopSafeCheck * 203/100
                                                  : BishopSafeCheck;
    else
    ...
    if (knightChecks & safe)
        kingDanger += more_than_one(knightChecks & safe) ? KnightSafeCheck * 124/100
                                                         : KnightSafeCheck;
    else
