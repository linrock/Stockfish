...
constexpr   Value LazyThreshold1 = Value(3435);
constexpr   Value LazyThreshold2 = Value(1932);
constexpr   int TUNE_psqThresh = 2097;
constexpr   int TUNE_nnueComplexityMult = 404;
constexpr   int TUNE_nnueOptCompOffset = 281;
constexpr   int TUNE_scaleBase = 975;
constexpr   int TUNE_scalePcMult = 128;
constexpr   int TUNE_scaleNonPawnMat = 60;
