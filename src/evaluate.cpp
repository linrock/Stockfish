...
namespace Stockfish {
  ...
  constexpr int TUNE_nnueScaleBase = 875;
  constexpr int TUNE_nnueScalePawnMult = 42;
  constexpr int TUNE_nnueScaleNpMult = 24;

  constexpr int TUNE_optScaleBase = 185;
  constexpr int TUNE_optScalePawnMult = 0;
  constexpr int TUNE_optScaleNpMult = 32;

  constexpr int TUNE_nnueComplexityOptOffset = 480;
