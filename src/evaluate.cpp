...
constexpr Value LazyThreshold1 = Value(3563);
constexpr Value LazyThreshold2 = Value(1996);
constexpr int TUNE_nnueComplexityMult = 413;
constexpr int TUNE_nnueNumOffset = 267;
constexpr int TUNE_psqlThresh = 1781;
