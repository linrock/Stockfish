...
namespace Stockfish {
    ...
    constexpr int TUNE_snNnueDiv = 21115;
    constexpr int TUNE_mainNnueDiv = 16212;
    constexpr int TUNE_vMatOffset = 75400;
    constexpr int TUNE_vSnDiv = 76515;
    constexpr int TUNE_vMainDiv = 76588;
