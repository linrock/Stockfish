...
constexpr   int TUNE_scaleBase = 956;
constexpr   int TUNE_scaleNonPawnMult = 36;
constexpr   int TUNE_nnueComplexityOptOffset = 419;
constexpr   int TUNE_optScaleOffset = 759;
constexpr   int TUNE_nnuePieceCountThresh = 4;
constexpr   int TUNE_nnuePsqClassicThresh = 2186;
