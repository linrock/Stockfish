...
namespace Eval {
  constexpr int TUNE_scale = 1089;
  constexpr int TUNE_numPawnsMult = 3;
  constexpr int TUNE_nonPawnMaterialMult = 66;
  constexpr int TUNE_classicalPsqThresh = 1788;
...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3462);
