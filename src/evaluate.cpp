...
namespace Stockfish {
    ...
    constexpr int TUNE_ncMult = 34;
    constexpr int TUNE_seMult = 22;
    constexpr int TUNE_optDenom = 13013;
    constexpr int TUNE_nnueDenom = 1214513;
    constexpr int TUNE_nnueNpmBase = 915;
    constexpr int TUNE_optNpmBase = 78;
