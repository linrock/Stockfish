...
namespace Stockfish {
 ...
 constexpr int TUNE_snOptDiv = 433;
 constexpr int TUNE_mainOptDiv = 503;
 constexpr int TUNE_snNnueDiv = 21337;
 constexpr int TUNE_mainNnueDiv = 18554;
 constexpr int TUNE_vMatOffset = 78256;
 constexpr int TUNE_vSnDiv = 75138;
 constexpr int TUNE_vMainDiv = 77696;
