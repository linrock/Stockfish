...
constexpr   int TUNE_knightMult = 431;
constexpr   int TUNE_bishopMult = 204;
constexpr   int TUNE_rookMult = 561;
constexpr   int TUNE_queenMult = 859;
constexpr   int TUNE_nnueBase = 881;
constexpr   int TUNE_optBase = 173;
