...
constexpr   Value LazyThreshold1 = Value(3616);
constexpr   Value LazyThreshold2 = Value(2004);
constexpr   int TUNE_psqThresh = 1785;
constexpr   int TUNE_nnueComplexityMult = 411;
constexpr   int TUNE_nnueOptCompOffset = 276;
constexpr   int TUNE_scaleBase = 1001;
constexpr   int TUNE_scalePcMult = 123;
constexpr   int TUNE_scaleNonPawnMat = 61;
