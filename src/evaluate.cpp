...
constexpr   Value TUNE_LazyThreshold1 = Value(3617);
constexpr   Value TUNE_LazyThreshold2 = Value(1957);
constexpr   int TUNE_nnuePieceCountThresh = 6;
constexpr   int TUNE_nnuePsqClassicThresh = 2190;
