...
constexpr Value LazyThreshold1 = Value(3593);
constexpr Value LazyThreshold2 = Value(1990);
constexpr int TUNE_psqlThresh = 1780;
constexpr int TUNE_nnueComplexityMult = 419;
