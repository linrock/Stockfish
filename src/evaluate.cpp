...
bool Eval::use_smallnet(const Position& pos) {
    ...
    return std::abs(simpleEval) > 964 + 6 * pawnCount * pawnCount / 16 + pawnCount;
}
...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    int material = 207 * pos.count<PAWN>() + 350 * pos.count<KNIGHT>() + 400 * pos.count<BISHOP>()
                 + 640 * pos.count<ROOK>() + 1200 * pos.count<QUEEN>();

    v = (nnue * (34300 + material) + optimism * (4400 + material)) / 36292;
