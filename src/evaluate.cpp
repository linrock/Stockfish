...
namespace {
  ...
  constexpr Value LazyThreshold1    =  Value(3723);
  constexpr Value LazyThreshold2    =  Value(2170);
...
Value Eval::evaluate(const Position& pos) {
  ...
  bool useClassical = !useNNUE || abs(psq) > 2126;
  ...
  else
  {
      ...
      v = (nnue * (956 + npm) + optimism * (150 + npm)) / 1024;
  }
