...
namespace Stockfish {
    ...
    constexpr int snThresh = 1042;
    constexpr int optDiv = 510;
    constexpr int nnueDiv = 32471;
    constexpr int pcMult = 392;
    constexpr int nnueMatOffset = 34511;
    constexpr int optMatOffset = 4590;
    constexpr int evalDiv = 35681;
