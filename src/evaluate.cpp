...
namespace Stockfish {
  ...
  constexpr int TUNE_shufMult = 20;
  constexpr int TUNE_lazyOffset = -205;
  constexpr int TUNE_nnueNpmBase = 926;
  constexpr int TUNE_nnuePc = 8;
  constexpr int TUNE_optNpmBase = 131;
...
Value Eval::evaluate(const Position& pos) {
    ...
    bool lazy = abs(simpleEval) >=   RookValue + KnightValue
                                   + TUNE_shufMult * shuffling * shuffling
