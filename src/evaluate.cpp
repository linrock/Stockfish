...
namespace Stockfish {
    ...
    constexpr int snThresh = 952;
    constexpr int reThresh = 220;
    constexpr int optDiv = 458;
    constexpr int nnueDiv = 18865;
    constexpr int nnueMatOffset = 73876;
    constexpr int optMatOffset = 8072;
    constexpr int evalDiv = 75888;
