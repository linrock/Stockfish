...
Value Eval::evaluate(const Position& pos) {
    ...
    else
    {
        ...
        optimism += optimism * (nnueComplexity + abs(simpleEval - nnue)) / 404;
        nnue -= nnue * (nnueComplexity + abs(simpleEval - nnue)) / 65536;

        int npm = pos.non_pawn_material() / 64;
        v       = (nnue * (996 + npm + 10 * pos.count<PAWN>()) + optimism * npm) / 1024;
    }
