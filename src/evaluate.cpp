...
namespace {
  ...
  Value LazyThreshold1 = Value(3564);
  Value LazyThreshold2 = Value(1868);

  int TUNE_psqThresh = 1763;
  int TUNE_scaleBase = 934;
  int TUNE_scalePawnMult = 7;
  int TUNE_scaleNonPawnMult = 67;
  int TUNE_nnueComplexityMult = 407;
  int TUNE_complexityOptOffset = 419;
  int TUNE_nnueOptCompOffset = 281;
  int TUNE_vScaleOffset = 742;
