...
constexpr   int TUNE_pawnMult = 79;
constexpr   int TUNE_knightMult = 457;
constexpr   int TUNE_bishopMult = 286;
constexpr   int TUNE_rookMult = 403;
constexpr   int TUNE_queenMult = 995;
