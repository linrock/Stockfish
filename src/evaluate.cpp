...
constexpr       int TUNE_ncOptMult = 26;
constexpr       int TUNE_semiOptMult = 28;
constexpr       int TUNE_ncNnueMult = 12;
constexpr       int TUNE_semiNnueMult = 18;
constexpr       int TUNE_nnueNpmBase = 956;
constexpr       int TUNE_optNpmBase = 140;
