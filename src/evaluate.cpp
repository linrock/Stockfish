...
constexpr       int TUNE_nnueScaleBase = 999;
constexpr       int TUNE_nnueScaleNpMult = 28;
constexpr       int TUNE_optScaleBase = 186;
constexpr       int TUNE_optScaleNpMult = 43;
constexpr       int TUNE_complexityMult = 446;
