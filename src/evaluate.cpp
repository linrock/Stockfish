...
namespace {
  ...
  Value LazyThreshold1 = Value(3463);
  Value LazyThreshold2 = Value(1827);

  int TUNE_psqThresh = 1797;
  int TUNE_scaleBase = 1024;
  int TUNE_scalePawnMult = 5;
  int TUNE_scaleNonPawnMult = 64;
  int TUNE_nnueComplexityMult = 402;
  int TUNE_complexityOptOffset = 425;
  int TUNE_nnueOptCompOffset = 273;
  int TUNE_vScaleOffset = 734;
