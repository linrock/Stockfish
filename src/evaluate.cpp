...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score BishopKingProtector = S(  6, 10);
  constexpr Score KnightKingProtector = S(  7, 10);
  constexpr Score KnightOnQueen       = S( 16, 11);
  constexpr Score LongDiagonalBishop  = S( 45,  0);
  constexpr Score MinorBehindPawn     = S( 18,  3);
  constexpr Score KnightOutpost       = S( 54, 48);
  constexpr Score BishopOutpost       = S( 32, 23);
  constexpr Score ReachKnightOutpost  = S( 30, 24);
