...
constexpr   int TUNE_classicDampNum = 194;
constexpr   int TUNE_classicDampDenom = 210;
constexpr   int TUNE_nnueDampNum = 189;
constexpr   int TUNE_nnueDampDenom = 219;
...
Value Eval::evaluate(const Position& pos) {
  ...
  if (useClassical) {
      ...
      v = v * (TUNE_classicDampNum - pos.rule50_count()) / TUNE_classicDampDenom;
  }
  else
  {
      int nnueComplexity;
