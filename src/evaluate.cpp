...
constexpr       Value TUNE_LazyThreshold1 = Value(3750);
constexpr       Value TUNE_LazyThreshold2 = Value(1995);
constexpr       int TUNE_psqThresh = 2094;
constexpr       int TUNE_npmOffset = 970;
constexpr       int TUNE_optOffset = 189;
