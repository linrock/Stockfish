...
constexpr       Value TUNE_LazyThreshold1 = Value(3608);
constexpr       Value TUNE_LazyThreshold2 = Value(2058);
constexpr       int TUNE_psqThresh = 2075;
constexpr       int TUNE_npmOffset = 1018;
constexpr       int TUNE_optOffset = 140;
