...
namespace Stockfish {
    ...
    constexpr int snThresh = 1009;
    constexpr int optDiv = 475;
    constexpr int nnueDiv = 32527;
    constexpr int nnuePcMult = 151;
    constexpr int optPcMult = 85;
    constexpr int evalDiv = 36384;
