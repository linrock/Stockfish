...
constexpr   Value LazyThreshold1 = Value(3424);
constexpr   Value LazyThreshold2 = Value(1828);
constexpr   int TUNE_psqThresh = 1792;
constexpr   int TUNE_scaleBase = 995;
constexpr   int TUNE_scalePawnMult = 7;
constexpr   int TUNE_scaleNonPawnMult = 60;
constexpr   int TUNE_nnueComplexityMult = 407;
constexpr   int TUNE_complexityOptOffset = 426;
constexpr   int TUNE_nnueOptCompOffset = 272;
constexpr   int TUNE_vScaleOffset = 753;
