...
constexpr int TUNE_nnueNpmBase = 996;
constexpr int TUNE_optNpmBase = 124;
constexpr int TUNE_nnueScalePc = 12;
constexpr int TUNE_optScalePc = 2;
constexpr int TUNE_dampNum = 200;
