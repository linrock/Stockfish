...
constexpr int TUNE_nnueNpmMult = 37;
constexpr int TUNE_optNpmMult = 22;
constexpr int TUNE_nnueNpmBase = 911;
constexpr int TUNE_optNpmBase = 102;
constexpr int TUNE_nnueScalePc = 3;
constexpr int TUNE_optScalePc = 7;
