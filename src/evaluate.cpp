...
constexpr Value LazyThreshold2 = Value(1993);
constexpr int TUNE_psqlThresh = 1784;
constexpr int TUNE_nnueScale = 990;
constexpr int TUNE_nnueScalePc = 7;
constexpr int TUNE_nnueScaleNpMat = 61;
constexpr int TUNE_nnueComplexityMult = 384;
constexpr int TUNE_nnueNumOffset = 302;
