...
constexpr   int TUNE_scaleBase = 979;
constexpr   int TUNE_nnueComplexityOptOffset = 518;
constexpr   int TUNE_optScaleOffset = 772;
constexpr   int TUNE_nnuePieceCountThresh = 8;
constexpr   int TUNE_nnuePsqClassicThresh = 2184;
