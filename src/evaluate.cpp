...
constexpr   Value LazyThreshold1 = Value(3477);
constexpr   Value LazyThreshold2 = Value(2047);
constexpr   int TUNE_psqThresh = 1938;
constexpr   int TUNE_nnueComplexityMult = 401;
constexpr   int TUNE_nnueOptCompOffset = 284;
constexpr   int TUNE_scaleBase = 1005;
constexpr   int TUNE_scalePcMult = 164;
constexpr   int TUNE_scaleNonPawnMat = 57;
