...
namespace Stockfish {
    ...
    constexpr int snThresh = 948;
    constexpr int reThresh = 221;
    constexpr int optDiv = 457;
    constexpr int nnueDiv = 19196;
    constexpr int nnueMatOffset = 72004;
    constexpr int optMatOffset = 8088;
    constexpr int evalDiv = 73951;
