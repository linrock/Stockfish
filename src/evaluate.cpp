...
constexpr   int TUNE_nnueNpmMult = 17;
constexpr   int TUNE_optNpmMult = 34;
constexpr   int TUNE_nnueNpmOffset = 935;
constexpr   int TUNE_optNpmOffset = 106;
constexpr   int TUNE_optMult = 1916;
constexpr   int TUNE_nnueDecayMult = 12;
...
Value Eval::evaluate(const Position& pos) {
  ...
  v = (  nnue     * (TUNE_nnueNpmOffset + nnueNpm + 9 * pos.count<PAWN>())
       + optimism * (TUNE_optNpmOffset  + optNpm  +     pos.count<PAWN>())) / 1024;
