...
Network<Arch, Transformer>::evaluate(const Position&                         pos,
                                     AccumulatorCaches::Cache<FTDimensions>* cache, bool psqtOnly) const {
    ...
    //     dbg_hit_on(std::abs(psqt) > 20000);
    // }
    if (Arch::TransformedFeatureDimensions == TransformedFeatureDimensionsBig && std::abs(psqt) > 20000) {
        psqtOnly = true;
    }
