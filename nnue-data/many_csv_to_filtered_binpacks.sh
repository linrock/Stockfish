...
function csv_zst_to_filtered_binpack() {
  ...
  filtered_plain_filename=${input_csv_zst_filename}.filter-v2.plain
  output_filtered_binpack_filename=${input_csv_zst_filename}.filter-v2.binpack
  filter_log_filename=${input_csv_zst_filename}.filter-v2.log
  if [ -f $output_filtered_binpack_filename ]; then
    ...
    python3 /home/ubuntu/stockfish/nnue-data/csv_filter_v2.py $input_csv_zst_filename >> $filter_log_filename
